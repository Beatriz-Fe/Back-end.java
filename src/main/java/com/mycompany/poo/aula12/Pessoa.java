...
public class Pessoa {
     ...
     * que é chamado no momento que instânciamos a mesma.
     * 
    ...
    //Não se pode ter mais de um mesmo parâmetro e tipo
    ...
    public Pessoa (String nome, double altura) {
        this.nome = nome;
        this.altura = altura;
        System.out.println("Construtor 5");
    }
     ...
     * porém com diferenças quanto à quantidade, tipos de parâmetro e retorno
     * 
